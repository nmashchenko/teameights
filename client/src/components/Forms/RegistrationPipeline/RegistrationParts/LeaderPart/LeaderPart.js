...
function LeaderPart() {
  ...
  const { progress, userData } = useSelector((state) => state.registrationReducer)
      ...
      <Container>
        ...
        <CardContainer>
          <InfoContainer>
            ...
            <TopText fontSize="14px" fontWeight="500" margin="20px 0 10px 0">
              Please note that leaders will be marked with special emoji 👑 and will be required to
              control their teams.
            </TopText>
            <TopText fontSize="14px" fontWeight="700" margin="0 0 10px 0">
              Team leaders typically have more than 1 year of experience.
            </TopText>
          </InfoContainer>
          <MiddleTextContainer>
            <SelectField
