...
import {EditUserDetails} from "./ProfileForm.styles";
import EditIcon from "../../../../assets/EditIcon";
import {Formik} from "formik";
import CustomInput from "../../../../shared/components/CustomInput/CustomInput";

const ProfileForm = ({user, team}) => {
    const inputStyles = {border: '1px solid #5E5E5E', borderRadius: '0.5rem', padding: '0.5rem', marginTop: '1rem'}
    return (
        <Formik initialValues={{fullName: user.userRealName}}>
            {() => {
            return (
                <>
                    <LeftCard>
                        ...
                        <TextContainer>
                            <CustomInput  name="fullName" style={inputStyles}/>
