...
export function generateSystemNotification(): ISystemNotification {
  return {
    id: faker.number.int(),
...
export function generateTeamInvitationNotification(): ITeamInvitationNotification {
  return {
    id: faker.number.int(),
    user: generateUserMockData(),
    type: 'team_invite',
...
export function generateRandomNotification(): ISystemNotification | ITeamInvitationNotification {
